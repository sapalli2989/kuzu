...
struct BatchInsertSharedState {
    ...
    common::row_idx_t getNumRows() { return numRows.load(); }
    // NOLINTNEXTLINE(readability-make-member-function-const): Semantically non-const.
    void logBatchInsertWALRecord() { wal->logCopyTableRecord(table->getTableID()); }
    void updateNumTuplesForTable() { table->updateNumTuplesByValue(getNumRows()); }
};
