...
private:
    ...
    std::unique_ptr<RelSetExecutor> getRelSetExecutor(planner::LogicalSetPropertyInfo* info,
        const planner::Schema& inSchema) const;
    std::unique_ptr<NodeDeleteExecutor> getNodeDeleteExecutor(const binder::BoundDeleteInfo& info, const planner::Schema& schema);
    std::unique_ptr<RelDeleteExecutor> getRelDeleteExecutor(const binder::BoundDeleteInfo& info, const planner::Schema& schema);
    ExtraNodeDeleteInfo getExtraNodeDeleteInfo(common::table_id_t tableID);
