...
struct UDF {
    ...
    template<typename TR, typename... Args>
    static function_set getFunctionDefinition(const std::string& name, TR (*udfFunc)(Args...),
    ...
    template<typename TR, typename... Args>
    static function_set getVectorizedFunctionDefinition(
    ...
    static function_set getVectorizedFunctionDefinition(const std::string& name,
