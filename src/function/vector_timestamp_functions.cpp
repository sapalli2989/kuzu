...
function_set CenturyVectorFunction::getFunctionSet() {
    function_set result;
...
function_set EpochMsVectorFunction::getFunctionSet() {
    function_set result;
...
function_set ToTimestampVectorFunction::getFunctionSet() {
    function_set result;
